...
# ==========================================
# TAB 3: EXECUTIVE DASHBOARD (BULLETPROOF)
# ==========================================
with tab3:
    ...
    if exec_file:
        ...
        if sales_col:
            # BULLETPROOF MATH: Force to number, turn blanks into 0
            total_sales = pd.to_numeric(df[sales_col], errors='coerce').fillna(0).sum()
        ...
        if cust_col and sales_col:
            # Ensure we only group by actual numbers
        ...
        with chart1:
            ...
            if date_col and sales_col:
                ...
                st.info("Need a 'Date' and 'Sales' column for trend.")
        ...
        with chart2:
            ...
            if cust_col and sales_col:
                ...
                st.info("Need a 'Customer' and 'Sales' column.")
        ...
        with chart3:
            ...
            if city_col and sales_col:
                ...
                st.info("Need a 'City/Location' column.")
        ...
        with chart4:
            ...
            if cat_col and sales_col:
                ...
                st.info("Need a 'Category/Product' column.")
